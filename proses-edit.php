...
if(isset($_POST['simpan'])){
    ...
    if( $query ) {
        ...
        // Tampilan status jika gagal menyimpan perubahan
        showErrorPage("Gagal menyimpan perubahan...", "Terjadi kesalahan saat memperbarui data di database.", "form-edit.php?id=".$id);
    }

} else {
    // Tampilan status jika akses dilarang (akses langsung tanpa form)
    showErrorPage("Akses Dilarang", "Anda tidak memiliki akses langsung ke halaman pemrosesan ini.", "list-siswa.php");
}

// Fungsi Helper untuk Menampilkan Halaman Error dengan Desain Pastel Soft
...
<head>
    ...
    <title><?php echo $title; ?> | SMK KRIAN 1</title>
    <!-- Tailwind CSS CDN -->
